...
import modulo.sistema.modelo.negocio.UsuarioLogado;
...
public abstract class Busca extends javax.swing.JInternalFrame {
    ...
    public Busca(String nome, String titulo) {
        this.setName(nome);
    ...
    public void atualizarGrid(int selecionar, List<Object> registros) {
        controlador.atualizarGrid(selecionar, registros);
    }
    
    public void botaoNovoActionPerformed(java.awt.event.ActionEvent evt) {
        controlador.botaoNovoActionPerformed(evt);
    }
    
    public void botaoEditarActionPerformed(java.awt.event.ActionEvent evt) {
        controlador.botaoEditarActionPerformed(evt);
    }
    
    public void botaoExcluirActionPerformed(java.awt.event.ActionEvent evt) {
        controlador.botaoExcluirActionPerformed(evt);
    }
    
    public void botaoBuscarActionPerformed(java.awt.event.ActionEvent evt) {
        controlador.botaoBuscarActionPerformed(evt);
    }
